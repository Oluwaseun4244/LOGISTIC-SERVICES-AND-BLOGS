                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                   ...
                                   <h4 style="color:green"> {{$edited}} </h4><br>
                                    <h4><a href="/settings">Return to settings</a></h4>
                                    @else
                                
                                    <form action="" method="POST">
                                        @csrf

                                        <label for="">WE ARE</label><br>
                                        <input type="text" name="weAre"  value="{{$settingsToEdit->weAre}}"><br>
                                        <label for="">FIRST</label><br>
                                        <textarea style="resize:none" name="first" cols="60" rows="10">{{$settingsToEdit->first}}</textarea><br>
                                     
                                        <label for="">SECOND</label><br>
                                        <textarea style="resize:none" name="second" cols="60" rows="10">{{$settingsToEdit->second}}</textarea><br>
                                    
                                        <label for="">FOUNDER</label><br>
                                        <input type="text" name="founder"  value="{{$settingsToEdit->founder}}"><br><br>

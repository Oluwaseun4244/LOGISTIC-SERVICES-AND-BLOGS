        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Rate Editor</a>
                </li>
                {{-- <li class="nav-item d-none d-sm-inline-block">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="http://127.0.0.1:8000/admindashboard" class="nav-link">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3>
                                        {{-- @dd(Session::Get("faqsaved")) --}}
                                        {{-- @if ($msg = Session::Get('faqsaved'))
                                            {{ $msg }}
                                ...
                                <div class="card-body">
                                   ...
                                   <h4> {{$edited}} </h4><br>
                                    <h4><a href="/calculator">Return to Rate Editor</a></h4>
                                    @else
                                
                                    <form action="" method="POST">
                                        @csrf

                                        <label for="">KG</label><br>
                                        <input type="number" name="kg"  value="{{$recordToEdit->kg}}"><br>
                                        <label for="">KM</label><br>
                                        <input type="number" name="km"  value="{{$recordToEdit->km}}"><br>
                                        <label for="">AIR FREIGHT</label><br>
                                        <input type="number" name="air_freight"  value="{{$recordToEdit->air_freight}}"><br>
                                        <label for="">OCEAN FREIGHT</label><br>
                                        <input type="number" name="ocean_freight"  value="{{$recordToEdit->ocean_freight}}"><br>
                                        <label for="">ROAD FREIGHT</label><br>
                                        <input type="number" name="road_freight"  value="{{$recordToEdit->road_freight}}"><br><br>
                                        <button type="submit" style="background-color:green; color:white;">Save</button>
                                        <button style="background-color:red;"><a style="color:white;"  href="/calculator" >Back</a></button>
                                    </form>
                                    @endif
                                    {{-- @endforeach --}}
                                </div>

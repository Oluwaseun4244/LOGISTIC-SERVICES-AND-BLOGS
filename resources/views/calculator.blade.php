                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">RATE EDITOR</h3>
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            {{-- @foreach ($faqs as $faq) --}}
                                            @foreach ($calcdetails as $detail)
                                            <tr>
                                                <td>{{$detail->kg}}</td>
                                                <td>{{$detail->km}}</td>
                                                <td>{{$detail->air_freight}}</td>
                                                <td>{{$detail->ocean_freight}}</td>
                                                <td>{{$detail->road_freight}}</td>
                                             
                                                {{-- <td></td>   --}}
                                                <td>
                                                    <div id="faq-btns">
                                                        <a class="badge bg-green" href="/calcedit/{{$detail->id}}">Edit</a>
                                                        {{-- <a class="badge bg-danger" href="#">Delete</a> --}}
                                                        {{-- <span class="badge bg-green">Edit</span>

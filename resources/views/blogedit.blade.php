                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4>{{$message}}</h4>
                                    <h4><a href="/blogs">Return to blogs</a></h4>

                                    @else
                                    <form method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <label>Author</label><br>
                                        <input name="author" type="text" value="{{$blogToEdit["author"]}}" required><br>
                                        <label >Title</label><br>
                                        <input name="title" type="text" value="{{$blogToEdit["title"]}}" required><br>
                                        <label>Image</label><br>
                                        <input name="image" type="file" required value="{{$blogToEdit["image"]}}"><br>
                                        <label for="">Content</label><br>
                                        <textarea required style="resize:none" name="content"  cols="60" rows="10" value="{{$blogToEdit["content"]}}">{{$blogToEdit["content"]}}</textarea><br>

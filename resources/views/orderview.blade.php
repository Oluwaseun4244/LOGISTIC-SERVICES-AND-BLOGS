                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>DISTANCE</th>
                                                <td>{{ $oneId['distance'] }}</td>



                                                <td>
                                                    <div id="faq-btns">
                                                        {{-- <a class="badge bg-green" href="/orderview/{{$oneId->id}}">View</a> --}}
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>TRACKING ID</th>
                                                <td>{{ $oneId['trackingID'] }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="">
                                                        ...
                                                        <h4>{{$status}} for order {{$oneId["trackingID"]}}</h4>
                                                        {{-- <h4><a href="/orders">Return to orders</a></h4> --}}
                                                        @else
                                                        <form action="" method="POST">
                                                            ...
                                                            {{-- <input type="text" name="kg"  value="{{$statusToEdit->status}}"><br> --}}
                    
                                                            <button type="submit" style="background-color:green; color:white;">Save</button>
                                                            {{-- <button style="background-color:red;"><a style="color:white;"  href="/orders" >Back</a></button> --}}
                                                        </form>
                                                       @endif
                                                        {{-- @endforeach --}}
                                                    </div>
                                                    <div id="faq-btns">
                                                        {{-- <a class="badge bg-green"
                                                            href="/statusedit/{{ $oneId->id }}">Update</a> --}}
                                                    </div>
                                                    <div id="faq-btns">
                                                        <a class="badge bg-orange"
                                                            href="/orders">Go back</a>
                                                    </div>
                                                </td>
                                            </tr>
